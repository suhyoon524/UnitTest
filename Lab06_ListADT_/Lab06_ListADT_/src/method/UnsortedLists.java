...
public class UnsortedLists <T> implements ListInterface<T>  {


  protected final int DEFCAP = 100; // default capacity
  protected int origCap;            // original capacity
  protected T[] list;               // array to hold this list’s elements
  public static int numElements = 0;    // number of elements in this list
...
public UnsortedLists() 
  {
    list = (T[]) new Object[DEFCAP];
    origCap = DEFCAP;
  }

  public UnsortedLists(int origCap) 
  {
  ...
  public boolean isEmpty() {
	...
	if (list == null) {
	 ...
	 if ( UnsortedLists.numElements == 0) {
			isEmpty = true;
	}
		return isEmpty;
